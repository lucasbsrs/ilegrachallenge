package com.lucassilva.ilegrachallenge.config;
...
public class ArquivoPosicoesConfig {
	...
	public static final Integer POSICAO_CLIENTE_CNPJ = 1;
	public static final Integer POSICAO_CLIENTE_NOME = 2;
	public static final Integer POSICAO_CLIENTE_AREA_NEGOCIO = 3;
